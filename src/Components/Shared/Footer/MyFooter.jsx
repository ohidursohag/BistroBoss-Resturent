...
const MyFooter = () => {
   return(
      <div className="w-full">
         <div className="flex flex-col md:flex-row text-white font-medium">
            <div className="bg-[#1F2937] flex-1 text-center py-[90px]">
            ...
            <div className="bg-[#111827] flex-1 text-center py-[90px]">
               <h2 className="text-[32px] mb-6 ">Follow US</h2>
               <p className="mb-5 text-xl">Join us on social media</p>
         ...
         <div className="bg-black text-white py-3 text-center">
            <p>Copyright &copy; <Link to='/' className="text-cyan-600 hover:text-cyan-400 hover:underline">Bistro Boss</Link>  All rights reserved</p>
         </div>
      </div>
   )}
